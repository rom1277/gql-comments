...
func (ec *executionContext) _Mutation_createPost(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNPost2ᚖgqlᚑcommentsᚋstorageᚐPost(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Query_posts(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	res := resTmp.([]*storage.Post)
	fc.Result = res
	return ec.marshalOPost2ᚕᚖgqlᚑcommentsᚋstorageᚐPostᚄ(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalNPost2gqlᚑcommentsᚋstorageᚐPost(ctx context.Context, sel ast.SelectionSet, v storage.Post) graphql.Marshaler {
	return ec._Post(ctx, sel, &v)
}

func (ec *executionContext) marshalNPost2ᚖgqlᚑcommentsᚋstorageᚐPost(ctx context.Context, sel ast.SelectionSet, v *storage.Post) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "the requested element is null which the schema does not allow")
		}
...
func (ec *executionContext) marshalOPost2ᚕᚖgqlᚑcommentsᚋstorageᚐPostᚄ(ctx context.Context, sel ast.SelectionSet, v []*storage.Post) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	ret := make(graphql.Array, len(v))
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNPost2ᚖgqlᚑcommentsᚋstorageᚐPost(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
